            ...
            <div className="wbdv-widgets ">
                ...
                <ul className="list-group">
                        <div className="widget-item">
                            ...
                            <input type="text" className="form-control wbdv-widget-vertical" placeholder="Heading text"/>
                            ...
                            <input type="text" className="form-control wbdv-widget-vertical" placeholder="Widget name"/>
                            <h3>Preview</h3>
                            <h1>Heading text</h1>
                        </div>
                </ul>
